...
class BskyNotificationBar extends HTMLElement {
  ...
  render() {
    ...
    ` : '';
      ...
      return `
        <div class="row" data-open="${esc(primaryUrl)}" title="${title}">
    ...
    const settings = (this.expanded && this.mode === 'settings') ? `
      <div class="settings">
        ...
        <div class="settings-body">
          ${this.settingsTab === 'cache' ? '<bsky-cache-status data-compact="1"></bsky-cache-status>' : ''}
    ...
    // Hook infinite scroll (expanded view only).
